<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Rebel_foods.index" %>
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    ...
                    <% if (Session["isLoggedIn"] != null) {%>           
                     <a   href="BuyCart.aspx"><img src="images/cart.png" style="height:50px; width:50px;"/> <span id="span" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" runat="server">99+</span></a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <div class="banner-section-bg-container d-flex justify-content-center flex-column">
        <div class="text-center">
            ...
            <asp:Button ID="Button1" class="custom-button" runat="server" Text="View Menu" OnClick="Button1_Click" />
            <asp:Button ID="Button2" class="custom-outline-button" runat="server" Text="Order Now" OnClick="Button2_Click" />
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <asp:Button ID="Button3" class="custom-button" runat="server" Text="Watch Video" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 d-flex flex-column justify-content-center">
                    ...
                    <div>
                        <asp:Button ID="Button4" class="custom-button" runat="server" Text="Redeem Gift" />
                    </div>
                </div>
